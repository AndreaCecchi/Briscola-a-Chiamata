...
public class Partita : MonoBehaviour
{
    ...
    public static void AggiungiGiocatori(Giocatore g)
    {
        listagiocatori.Add(g);
    }
    public static void AggiungiCarteBot(List<Carta> carte)
    {
    ...
    public static void FineMano()
    {
        ...
        if (posizionevincitore == listagiocatori[0].posizione)
        {
        ...
        }else if (posizionevincitore == listagiocatori[1].posizione)
        {
            List<GameObject> carte = GameObject.FindGameObjectsWithTag("card").ToList<GameObject>();
            foreach (GameObject c in carte)
            {
        ...
        else if (posizionevincitore == listagiocatori[2].posizione)
        {
            List<GameObject> carte = GameObject.FindGameObjectsWithTag("card").ToList<GameObject>();
            foreach (GameObject c in carte)
            {
        ...
        else if (posizionevincitore == listagiocatori[3].posizione)
        {
            List<GameObject> carte = GameObject.FindGameObjectsWithTag("card").ToList<GameObject>();
            foreach (GameObject c in carte)
            {
        ...
        else if (posizionevincitore == listagiocatori[4].posizione)
        {
            List<GameObject> carte = GameObject.FindGameObjectsWithTag("card").ToList<GameObject>();
            foreach (GameObject c in carte)
            {
        ...
        else
        {
            ...
            else
            {
                ...
                //SceneManager.LoadScene("ScegliCarta", LoadSceneMode.Additive);
            }
        }
        

    }
    public static Tuple<Carta,int> VincitoreMano(Dictionary<int,Carta> cartegiocate)
    {
