...
public class GestioneTurno : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameObject.FindWithTag("inserimentocarta").GetComponent<Text>().text = ("Il giocatore " + GameObject.FindWithTag("Gio1").GetComponent<Text>().text + " inserisca la carta da giocare (valore, seme):/n");
