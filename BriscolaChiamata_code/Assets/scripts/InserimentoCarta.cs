...
public class InserimentoCarta : MonoBehaviour
{
    ...
    public static void InserisciCarta()
    {
        if (Partita.turnoGiocatore[Partita.turnoCorrente] == Partita.turnoGiocatore[0])
        {
    ...
    public static UnityEngine.Sprite TrovaCarta(Carta c )
    {
        switch (c.seme)
        {
            case "bastoni":
